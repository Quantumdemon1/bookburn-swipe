...
import { Book, Music, Film, GamepadIcon, MoreVertical, Shield, Ban, Flag } from 'lucide-react';
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap gap-1">
                {friend.interests.map(interest => {
                  ...
                  return (
                    <span key={interest} className={`inline-flex items-center gap-1 text-xs px-2 py-1 rounded-full 
      ...
      <CardContent className={viewMode === 'list' ? 'flex-1 flex items-center gap-4' : ''}>
        ...
        <div className={`flex ${viewMode === 'list' ? 'w-48' : 'space-x-2'}`}>
          <Button 
            ...
            className="flex-1 group-hover:bg-primary/90 transition-colors bg-red-600 hover:bg-red-500 text-slate-50"
          >
            View Profile
          </Button>
