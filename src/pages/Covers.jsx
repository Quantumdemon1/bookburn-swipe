...
const Covers = () => {
  ...
  return <div className="container mx-auto sm:px-6 lg:px-8 px-[240px]">
      ...
      <FilterSection onSearch={handleSearch} onGenreChange={handleGenreChange} />
      ...
      <div className="mt-8">
        <AnimatePresence mode="wait">
          ...
          }} onBurn={() => handleAction('burn')} onLike={() => handleAction('like')} onFavorite={() => handleAction('favorite')} />
            </motion.div>}
        </AnimatePresence>
      </div>
    </div>;
