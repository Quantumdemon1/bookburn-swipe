        ...
        <CardContent className="p-6">
          <form className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="name" type="text" placeholder="Your Name" className="bg-gray-800 text-white border-gray-700" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="confirmPassword" type="password" placeholder="••••••••" className="bg-gray-800 text-white border-gray-700" />
            </div>
